describe("formSerializer", function() {
    ...
    beforeEach(function() {
        ...
        it("should return corrent formSerializer", function() {
          ...
          var realanswerlist = [{name: "Q1-1", type: 'text',answer: ["统一建模语言"]},
          {name: "Q1-2",type: 'text',answer: ["三", "二", "一"] },
          {name: "Q2-1",type: 'radio',answer: ["B"]},
          {name: "Q2-2",type: 'radio',answer: ["C"]},
          {name: "Q3-1",type: 'checkbox',answer: ["A", "B", "C"]},
          {name: "Q3-2",type: 'checkbox',answer: ["A", "B", "D"]},
          {name: "Q4-1",type: 'radio',answer: ["对"]},
          {name: "Q4-2",type: 'radio',answer: ["错"]},
          {name: "Q5-1",type: 'text',answer: ['模型的表现形式']} ];
